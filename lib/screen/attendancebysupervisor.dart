...
class AttendanceSuperVisorByUser extends StatelessWidget {
...
Future<void> getAttendanceInfo(
  ...
  final url = Uri.parse(
    "${urls.token_url}/api/Attendance/AttendanceBySupervisor/${userName}/${current_month}01/${current_month}30",
  );
...
Future<void> getAttendanceInfoAnotherSEarch(String userName, Token token,
  ...
  final url = Uri.parse(
    "${urls.token_url}/api/Attendance/AttendanceBySupervisor/${userName}/${start_date}/${end_date}",
  );
